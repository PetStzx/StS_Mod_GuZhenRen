...
import GuZhenRen.cards.XuePiaoLiu;
import GuZhenRen.cards.XueZouGu;
import GuZhenRen.patches.GuZhenRenTags;
import com.megacrit.cardcrawl.cards.AbstractCard;

import java.util.ArrayList;

public class Recipe_XuePiaoLiu extends AbstractRecipeRelic {
    public static final String ID = GuZhenRen.makeID("Recipe_XuePiaoLiu");
    private static final String IMG = "Recipe_XueDao.png";
    private static final String OUTLINE = "Recipe_XueDao.png";

    public Recipe_XuePiaoLiu() {
