        ...
        AddAudioSubscriber
{
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard(new TuQiangGu());
        BaseMod.addCard(new LongLinGu());
        BaseMod.addCard(new HuaShiGu());
        BaseMod.addCard(new HuangSha());
        BaseMod.addCard(new LeiGuDunGu());
        BaseMod.addCard(new DiMai());
        BaseMod.addCard(new BaiGuZhanChe());
        ...
        BaseMod.addCard(new XueRanZhengPao());
        BaseMod.addCard(new LuanFangHunXiangWu());
        BaseMod.addCard(new RanNianFeiShi());
        BaseMod.addCard(new YinGuoShenShu());
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new TouSheng(), CardColorEnum.GUZHENREN_GREY);
        BaseMod.addRelicToCustomPool(new FeiLiGu(), CardColorEnum.GUZHENREN_GREY);
        BaseMod.addRelicToCustomPool(new NongXuGu(), CardColorEnum.GUZHENREN_GREY);
        BaseMod.addRelicToCustomPool(new TuDuiGu(), CardColorEnum.GUZHENREN_GREY);
        BaseMod.addRelicToCustomPool(new CunGuangYin(), CardColorEnum.GUZHENREN_GREY);
        ...
        BaseMod.addRelicToCustomPool(new FeiGuDunGu(), CardColorEnum.GUZHENREN_GREY);
        BaseMod.addRelicToCustomPool(new GuCiGu(), CardColorEnum.GUZHENREN_GREY);
        ...
        BaseMod.addRelicToCustomPool(new FengXiongHuaJi(), CardColorEnum.GUZHENREN_GREY);
        BaseMod.addRelicToCustomPool(new NengLiGu(), CardColorEnum.GUZHENREN_GREY);
        BaseMod.addRelicToCustomPool(new MuYa(), CardColorEnum.GUZHENREN_GREY);
        BaseMod.addRelicToCustomPool(new JianChiGu(), CardColorEnum.GUZHENREN_GREY);
        BaseMod.addRelicToCustomPool(new NiLiuHe(), CardColorEnum.GUZHENREN_GREY);
