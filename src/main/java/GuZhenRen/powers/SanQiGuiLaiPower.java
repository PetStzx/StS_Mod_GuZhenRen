...
public class SanQiGuiLaiPower extends AbstractPower {
    public static final String POWER_ID = GuZhenRen.makeID("SanQiGuiLaiPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    public SanQiGuiLaiPower(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = -1;
        ...
        String pathLarge = GuZhenRen.assetPath("img/powers/SanQiGuiLaiPower_p.png");
        String pathSmall = GuZhenRen.assetPath("img/powers/SanQiGuiLaiPower.png");
